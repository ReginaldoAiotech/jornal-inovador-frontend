...
import { getPendingComments, moderateComment, deleteComment } from '../../services/courseService';
...
export default function PendingCommentsPage() {
  useDocumentTitle('Comentarios Pendentes');
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold font-heading text-gray-900">Comentarios Pendentes</h1>
            ...
            <div key={comment.id} className="bg-white rounded-xl shadow-sm border border-yellow-200 p-5">
              ...
              {comment.lessonTitle && (
                <div className="mb-3 pb-3 border-b border-gray-100">
                  ...
                  <Link
                    to={`/admin/cursos/aulas/${comment.lessonId}/comentarios`}
