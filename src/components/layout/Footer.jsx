      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <Link to={ROUTES.HOME}>
              <img src={logoSvg} alt="O Inovador" className="h-8 brightness-0 invert opacity-80" />
            </Link>
            <span className="text-xs text-primary-300 hidden sm:block">|</span>
            <p className="text-xs text-primary-300 hidden sm:block">Portal de noticias, editais e oportunidades</p>
          </div>
          <div className="flex items-center gap-4 text-xs text-primary-300 flex-wrap">
            ...
            <a href="mailto:contato@jornaldoinovador.com.br" className="hover:text-white transition-colors">Contato</a>
