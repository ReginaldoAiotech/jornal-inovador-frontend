...
const TEMPLATES = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'image', url: '', caption: '', credit: '', alt: '' },
      { type: 'divider' },
      { type: 'paragraph', text: '', _placeholder: '<strong>Plataforma Conex</strong> - Primeira pergunta ao entrevistado?' },
      { type: 'paragraph', text: '', _placeholder: '<strong>Nome do entrevistado</strong> - Resposta do entrevistado.' },
      { type: 'paragraph', text: '', _placeholder: '<strong>Plataforma Conex</strong> - Segunda pergunta?' },
      { type: 'paragraph', text: '', _placeholder: '<strong>Nome do entrevistado</strong> - Resposta.' },
      { type: 'paragraph', text: '', _placeholder: '<strong>Plataforma Conex</strong> - Terceira pergunta?' },
      { type: 'paragraph', text: '', _placeholder: '<strong>Nome do entrevistado</strong> - Resposta.' },
      { type: 'divider' },
